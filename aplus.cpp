	...
	if( state == start ){
        ...
        if(state == enter_stage){
            if(stage == 1){
                ...
                SDL_Rect diaR_1 = {400,100,dialogue[4].getWidth(),dialogue[4].getHeight()};                SDL_Rect diaR = {400,100,dialogue[4].getWidth(),dialogue[4].getHeight()};
                SDL_Rect diaR_2 = {400,100,opening_introduction.getWidth(),opening_introduction.getHeight()};
                dialogue[4].render(diaR_1.x,diaR_1.y,&diaR_1);
                opening_introduction.render(diaR_2.x,diaR_2.y,&diaR_2);
            }
        }
