...
game_state state = enter_stage;	  //define state as the variable indicates current game state
...
void get_aplus_script(){
	...
	if(!get_aplus_played){
        ...
        r[0].x = 0;
        r[0].y = 0;
        r[0].w = get_aplus_subtitle[1].getWidth();
        r[0].h = get_aplus_subtitle[1].getHeight();
